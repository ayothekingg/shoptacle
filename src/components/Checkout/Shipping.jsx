...
const Shipping = ({ next, checkoutToken }) => {
        ...
        <span className="">
          <span className="inline-flex flex-col ">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle cx="16.5" cy="16" r="16" fill="#121212" />
            </svg>
            <h1 className="inline text-xs font-oswald">Shipping</h1>
          </span>

          <span className="w-20 lg:w-40 border-shipping border-t-2 inline-block mb-3 mx-2"></span>
          <span className="inline-flex flex-col">
            <svg
              className="inline-block"
              width="32"
            ...
            <h1 className=" text-xs font-oswald">Payment</h1>
          </span>
          ...
          <span className="inline-flex flex-col">
            ...
            <h1 className="text-xs font-oswald">Review</h1>
          </span>
        </span>
          ...
          <form onSubmit={handleSubmit}>
            <div className=" border-[1px] rounded-md border-footerBg my-8 mx-4">
              <div className="my-8 mx-6 [&>input]:mb-5 [&>select]:mb-5">
                ...
                <label
                  ...
                  className="font-oswald text-xs text-buttonBlack font-bold leading-5 block"
                >
                  Email Address
                </label>
                <input
            ...
            "
                ...
                <select
                  ...
                  name="country"
                  className="font-oswald w-full max-w-lg border-[1px] border-footerBg rounded placeholder:font-oswald text-xs text-buttonBlack font-bold leading-5 py-3
            "
